  ...
  /* 로그인 팝업 */
   $(".login_popup").on("click",function(){
    ...
    $(window).on("scroll",function(){
        ...
        /* IMG 애니메이트 */
        if(strIMG>=1200){
            $(".detail_box01 img").stop().animate({"opacity":"1","top":"0px"});
        }else
            $(".detail_box01 img").css({"opacity":"0","top":"-20px"});
   
        if(strIMG>=1452){
            $(".detail_box01 .text_wrap").stop().animate({"opacity":"1","top":"0px"});    
        }else
            $(".detail_box01 .text_wrap").css({"opacity":"0","top":"-20px"});

        if(strIMG>=1504){
            $(".detail_box01 .text_info").stop().animate({"opacity":"1","top":"0px"});
        }else
            $(".detail_box01 .text_info").css({"opacity":"0","top":"-20px"});
        
        
        if(strIMG>=2000){
            $(".detail_box02 img").stop().animate({"opacity":"1","top":"0px"});
            
        }else
            $(".detail_box02 img").css({"opacity":"0","top":"-20px"});
        
        if(strIMG>=2301){
            $(".detail_box02 .text_wrap").stop().animate({"opacity":"1","top":"0px"});    
        }else
            $(".detail_box02 .text_wrap").css({"opacity":"0","top":"-20px"});
        
        if(strIMG>=2401){
            $(".detail_box02 .text_info").stop().animate({"opacity":"1","top":"0px"});
        }else
            $(".detail_box02 .text_info").css({"opacity":"0","top":"-20px"});
        
         if(strIMG>=2800){
            $(".detail_box03 img").stop().animate({"opacity":"1","top":"0px"});
            
        }else
            $(".detail_box03 img").css({"opacity":"0","top":"-20px"});
        
         if(strIMG>=2900){
            $(".detail_box03 .text_wrap").stop().animate({"opacity":"1","top":"0px"});    
        }else
            $(".detail_box03 .text_wrap").css({"opacity":"0","top":"-20px"});
        
        if(strIMG>=3000){
            $(".detail_box03 .text_info").stop().animate({"opacity":"1","top":"0px"});
        }else
            $(".detail_box03 .text_info").css({"opacity":"0","top":"-20px"});
        
        if(strIMG>=3501){
            $(".detail_box04 img").stop().animate({"opacity":"1","top":"0px"});
            
        }else
            $(".detail_box04 img").css({"opacity":"0","top":"-20px"});
         ...
         if(strIMG>=4750){
            $(".detail_box05 img").stop().animate({"opacity":"1","top":"0px"});
            
        }else
            $(".detail_box05 img").css({"opacity":"0","top":"-20px"});
